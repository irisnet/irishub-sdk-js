// source: cosmos/coinswap/genesis.proto
/**
 * @fileoverview
 * @enhanceable
...
var cosmos_coinswap_coinswap_pb = require('../../cosmos/coinswap/coinswap_pb.js');
goog.object.extend(proto, cosmos_coinswap_coinswap_pb);
...
proto.irismod.coinswap.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    params: (f = msg.getParams()) && cosmos_coinswap_coinswap_pb.Params.toObject(includeInstance, f)
  };
...
proto.irismod.coinswap.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new cosmos_coinswap_coinswap_pb.Params;
      reader.readMessage(value,cosmos_coinswap_coinswap_pb.Params.deserializeBinaryFromReader);
      msg.setParams(value);
      break;
    default:
      reader.skipField();
...
proto.irismod.coinswap.GenesisState.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      cosmos_coinswap_coinswap_pb.Params.serializeBinaryToWriter
    );
  }
};
...
proto.irismod.coinswap.GenesisState.prototype.getParams = function() {
  return /** @type{?proto.irismod.coinswap.Params} */ (
    jspb.Message.getWrapperField(this, cosmos_coinswap_coinswap_pb.Params, 1));
};
