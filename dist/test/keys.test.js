...
test('Keys', () => {
    const password = basetest_1.Consts.keyPassword;
    const client = basetest_1.BaseTest.getClient();
    // Create a new key
    ...
    // Recover a key
    const recoveredKeyAddr = client.keys.recover('name2', password, addedKey.mnemonic);
