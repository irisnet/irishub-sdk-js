...
import { MsgDefineService, MsgBindService, MsgUpdateServiceBinding, MsgDisableServiceBinding, MsgEnableServiceBinding, MsgSetServiceWithdrawAddress, MsgRefundServiceDeposit, MsgStartRequestContext, MsgPauseRequestContext, MsgKillRequestContext, MsgUpdateRequestContext, MsgWithdrawEarnedFees, MsgWithdrawTax, } from '../types/service';
...
export class Service {
    ...
    withdrawEarnedFees(baseTx) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = this.client.keys.show(baseTx.from);
            const msgs = [new MsgWithdrawEarnedFees(provider)];
            return this.client.tx.buildAndSend(msgs, baseTx);
        });
    }
    /**
    ...
    withdrawTax(destAddress, amount, baseTx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const msgs = [new MsgWithdrawTax(trustee, destAddress, coins)];
            return this.client.tx.buildAndSend(msgs, baseTx);
        });
    }
}
