...
goog.exportSymbol('proto.cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardRequest', null, global);
goog.exportSymbol('proto.cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardResponse', null, global);
...
proto.cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    rewardsList: jspb.Message.toObjectList(msg.getRewardsList(),
    cosmos_distribution_v1beta1_distribution_pb.TokenizeShareRecordReward.toObject, includeInstance),
    totalList: jspb.Message.toObjectList(msg.getTotalList(),
    cosmos_base_v1beta1_coin_pb.DecCoin.toObject, includeInstance)
  };
...
proto.cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new cosmos_distribution_v1beta1_distribution_pb.TokenizeShareRecordReward;
      reader.readMessage(value,cosmos_distribution_v1beta1_distribution_pb.TokenizeShareRecordReward.deserializeBinaryFromReader);
      msg.addRewards(value);
      break;
    case 2:
      var value = new cosmos_base_v1beta1_coin_pb.DecCoin;
...
proto.cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      cosmos_distribution_v1beta1_distribution_pb.TokenizeShareRecordReward.serializeBinaryToWriter
    );
  }
  f = message.getTotalList();
  if (f.length > 0) {
...
proto.cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardResponse.prototype.getRewardsList = function() {
  return /** @type{!Array<!proto.cosmos.distribution.v1beta1.TokenizeShareRecordReward>} */ (
    jspb.Message.getRepeatedWrapperField(this, cosmos_distribution_v1beta1_distribution_pb.TokenizeShareRecordReward, 1));
};
